...
@FunctionalInterface		//컴파일러 함수형 인터페리스임을 명시적으로 알림

interface FuncInterface1 {
	//FunctionalInterface 지정시 추가메소드가 없거나 2개 이상이면 에러 발생
	void method();
}
@FunctionalInterface
...
public class LambdaFormat {
	...
	public static void main(String[] args) {
		...
		//FuncInterface4 fi5 = (a, b) -> return a + b; //return 문만 있을 땐, {}만 생략 불가
		FuncInterface4 fi6 = (a, b) -> a + b;			//반환 값만 있는 경우, return / {} 동시 생략
